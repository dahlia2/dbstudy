...
SELECT DISTINCT JOB_ID  -- 동일한 ID은 제외하고 조회 (질의 결과 표시) (ASC가 기본으로 되어있으므로 따로 정렬 설정 x)    3
  FROM EMPLOYEES   -- 임폴리 테이블에서    1
 ORDER BY JOB_ID;  -- 잡아이디 칼럼    2
 
 
-- 2. EMPLOYEES 테이블에서 DEPARTMENT_ID가 50인 사원 중에서 SALARY가 5000 이상인 사원을 조회하시오.
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID  -- 조회 표시할 칼럼
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  FROM EMPLOYEES
 WHERE EMPLOYEE_1D BETWEEN 151 AND 200;   -- 151~200 비트윈 151 앤드 200
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
 ...
 WHERE TO_DATE(HIRE_DATE, 'YY/MM/DD')
       BETWEEN TO_DATE('2005/01/01', 'YYYY/MM/DD') AND TO_DATE ('2005/12/31', 'YYYY/MM/DD');
    -- 방법 2
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY, COMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, TO_CHAR(SALARY, '99,999') AS SALARY, COMISSION_PCT, MANAGER_ID, DEPARTMENT_ID
  FROM EMPLOYEES
 WHERE JOB_ID LIKE '%MAN';
