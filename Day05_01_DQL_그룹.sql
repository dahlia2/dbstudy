/*
    ...
    2. GROUP BY절에서 지정한 칼럼은 "반드시" GROUP BY절에 있어야 한다.(필수 규칙)
*/

-- 1. 동일한 DEPARTMENT_ID를 그룹화하여 조회하시오.
SELECT   DEPARTMENT_ID
  FROM   EMPLOYEES
GROUP BY DEPARTMENT_ID;  -- 이렇게 하면 추가 함수를 쓸 수 있음
