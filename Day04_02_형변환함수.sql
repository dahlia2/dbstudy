...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, HIRE_DATE
  FROM EMPLOYEES
 WHERE TO_DATE (HIRE_DATE, 'YY/MM/DD') BETWEEN T0_DATE('00/01/01', 'YY/MM/DD') AND TO_DATE('05/12/31', 'YY/MM/DD');
...
-- 됨
 SELECT DT1
  FROM SAMPLE_TBL
  WHERE DT1 = TO_DATE(DT1, 'YY/MM/DD'), = TO_DATE('23/02/07', 'YY-MM-DD');
